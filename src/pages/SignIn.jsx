      ...
      <div className="fixed top-0 left-0 w-full h-full bg-black/70 flex items-center justify-center">
        ...
        >
          <div className="w-[85%] mx-auto space-y-6">
            ...
            {error && (
              <p className="text-slate-300 text-sm bg-red-400 py-2 px-2">
                {error}
              </p>
            )}
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col w-full gap-5">
                ...
                <button className="bg-primary flex justify-center items-center w-full py-3 rounded font-semibold text-lg text-gray-300 mt-4">
                  {loader ? (
                    <Bars
                      height="30"
                      width="30"
            ...
            <div className="text-gray-500">
              New to Netflix?{" "}
              <Link to="/signup" className="text-gray-300 font-semibold">
                Sign Up
              </Link>
            </div>
          </div>
